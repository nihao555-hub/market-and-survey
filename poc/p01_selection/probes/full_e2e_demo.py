...
3. **采购成本不能编**
   ...
   - **如果都失败：不调用 full_cost_breakdown**！必须 record_stage_status('stage5_profit', 'skipped', reason='1688 抓取失败', needs_user_action='请提供 1688 URL 或工厂报价') 显式登记
...
- artifacts: 产出物列表（如 ["BSR Top 30 抓取", "71 条真评论", "3 张证据截图"]）
